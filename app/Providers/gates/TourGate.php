...
class TourGate
{
    public static function defineGates()
    {
        ...
        Gate::define('view_inventory_tour', function ($user) {
            ...
            $user->user_positions->perimitions->pluck('module')->contains('inventory_tour') &&
            $user->user_positions->perimitions->pluck('action')->contains('view') ) {
                return true;
            }
            return false;
        });
        Gate::define('add_inventory_tour', function ($user) {
            if ($user instanceof Agent || $user instanceof AffilateAgent) {
                return true;
            }
            if ($user->user_positions && 
        ...
        Gate::define('update_inventory_tour', function ($user) {
            if ($user instanceof Agent || $user instanceof AffilateAgent) {
                return true;
            }
            if ($user->user_positions && 
        ...
        Gate::define('delete_inventory_tour', function ($user) {
            if ($user instanceof Agent || $user instanceof AffilateAgent) {
                return true;
            }
            if ($user->user_positions && 
        ...
        Gate::define('gallary_inventory_tour', function ($user) {
            if ($user instanceof Agent || $user instanceof AffilateAgent) {
                return true;
            }
            if ($user->user_positions && 
