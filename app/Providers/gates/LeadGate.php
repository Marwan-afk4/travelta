...
class LeadGate
{
    public static function defineGates()
    {
        ...
        Gate::define('update_lead', function ($user) {
            if ($user instanceof Agent) {
                return true;
            }
            if ($user->user_positions && 
        ...
        Gate::define('delete_lead', function ($user) {
            if ($user instanceof Agent) {
                return true;
            }
            if ($user->user_positions && 
