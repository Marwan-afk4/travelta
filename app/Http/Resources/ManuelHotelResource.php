...
class ManuelHotelResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'to_email' => $this->to_client->emails ? $this->to_client->emails[0]: $this->to_client->email ?? null,
            'to_phone' => $this->to_client->phones ? strval($this->to_client->phones[0]): $this->to_client->phone ?? null,
