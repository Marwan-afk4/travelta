...
class SubscriperResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'to_email' => isset($this->to_client->emails) ? (is_string($this->to_client->emails) ? (json_decode($this->to_client->emails)[0]) : $this->to_client->emails): $this->to_client->email,
            'to_phone' => isset($this->to_client->phones) ? (is_string($this->to_client->phones) ? (json_decode($this->to_client->phones)[0]) : $this->to_client->phones): $this->to_client->phone,
        ];
    }
}
