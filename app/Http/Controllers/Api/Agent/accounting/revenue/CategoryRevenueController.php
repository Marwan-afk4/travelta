...
class CategoryRevenueController extends Controller
{
    ...
    public function view(Request $request){
        // agent/accounting/revenue/category
    ...
    public function category(Request $request, $id){
        // agent/accounting/revenue/category/item/{id}
        if ($request->user()->affilate_id && !empty($request->user()->affilate_id)) {
            $agent_id = $request->user()->affilate_id;
        }
        elseif ($request->user()->agent_id && !empty($request->user()->agent_id)) {
    ...
    public function create(Request $request){
        // agent/accounting/revenue/category/add
        // Keys
        // name, category_id
    ...
    public function modify(Request $request, $id){
        // agent/accounting/revenue/category/update/{id}
        // Keys
        // name, category_id
        $validation = Validator::make($request->all(), [
            'name' => 'required',
    ...
    public function delete(Request $request, $id){
        // agent/accounting/revenue/category/delete/{id}
        if ($request->user()->affilate_id && !empty($request->user()->affilate_id)) {
            $agent_id = $request->user()->affilate_id;
        }
        elseif ($request->user()->agent_id && !empty($request->user()->agent_id)) {
